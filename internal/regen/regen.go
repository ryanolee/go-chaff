...
type GeneratorArgs struct {
	...
	RngSource rand.Source `json:"-"`

	// Default is 0 (syntax.POSIX).
	Flags syntax.Flags `json:"-"`
	...
	MaxUnboundedRepeatCount uint `json:"maxUnboundedRepeatCount,omitempty"`
	// Minimum number of instances to generate for unbounded repeat expressions (e.g. ".*")
	// Default is 0.
	MinUnboundedRepeatCount uint `json:"minUnboundedRepeatCount,omitempty"`
	...
	CaptureGroupHandler CaptureGroupHandler `json:"-"`

	// Suppresses random bytes from being generated by generators
	SuppressRandomBytes bool `json:"suppressRandomBytes,omitempty"`

	// Adds an option to suppress broader scale generation of random bytes to printable ascii cahracters
	LimitToAscii bool `json:"limitToAscii,omitempty"`
